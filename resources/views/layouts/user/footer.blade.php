    ...
    <div class="container mx-auto px-4">
        ...
        <div class="border-t border-gray-300 pt-6 flex flex-col sm:flex-row justify-between items-center text-xs">
            <div class="flex space-x-4 mb-4 sm:mb-0">
                ...
                <a href="{{ $footer['company']?->instagram ? $footer['company']?->instagram : '#' }}" class="text-gray-500 hover:text-pink-600">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><rect width="20" height="20" x="2" y="2" rx="5" ry="5" /><path d="M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37z" /><line x1="17.5" y1="6.5" x2="17.51" y2="6.5" /></svg>
                </a>
                <a href="{{ $footer['company']?->youtube ? $footer['company']?->youtube : '#' }}" class="text-gray-500 hover:text-red-600">
                    <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path fill-rule="evenodd" d="M19.812 5.418c.861.23 1.538.907 1.768 1.768C21.998 8.78 22 12 22 12s0 3.22-.42 4.814a2.506 2.506 0 0 1-1.768 1.768C18.398 19 12 19 12 19s-6.398 0-7.812-1.418a2.506 2.506 0 0 1-1.768-1.768C2 15.22 2 12 2 12s0-3.22.42-4.814a2.506 2.506 0 0 1 1.768-1.768C5.602 5 12 5 12 5s6.398 0 7.812.418zM9.545 15.568V8.432L15.818 12 9.545 15.568z" clip-rule="evenodd"></path></svg>
                </a>
                <a href="{{ $footer['company']?->linkedin ? $footer['company']?->linkedin : '#' }}" class="text-gray-500 hover:text-blue-600">
                    ...
                    <a href="https://wa.me/{{ $footer['company']?->whatsapp }}" class="text-gray-500 hover:text-green-600">
