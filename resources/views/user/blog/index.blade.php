    ...
    <section class="bg-purple-900 text-white">
        <div class="container mx-auto px-4 py-12">
            <p class="text-sm text-purple-300 mb-2">Sentuh Blog</p>
            <h1 class="text-3xl lg:text-4xl font-bold max-w-2xl mb-6">Perkuat Brand Teknologi Lokal Sentuh berpartisipasi
                dalam Event Business Matching II p3dn</h1>
            <div class="relative rounded-lg overflow-hidden">
                <img src="https://placehold.co/1200x500/3B0764/FFFFFF?text=Featured+Post" alt="Featured Blog Post"
                    class="w-full h-auto">
                <div class="absolute bottom-0 left-0 p-8">
                    <div class="bg-black bg-opacity-50 backdrop-blur-sm p-4 rounded-lg max-w-sm">
                        <h2 class="text-xl font-bold mb-2">Digital Transformation Indonesia Conference & Expo 2023</h2>
                        <a href="/blog/show" class="text-purple-300 hover:text-white font-semibold">Read More
                            &rarr;</a>
                    </div>
                </div>
            </div>
                ...
                <div class="bg-white rounded-lg border border-gray-200 flex flex-col">
                    ...
                    <div class="p-5 flex flex-col flex-grow">
                        ...
                        <h3 class="font-bold text-lg mb-4 flex-grow">
                            <a href="/blog/show" class="hover:text-purple-700">PT Sentuh Digital Teknologi
