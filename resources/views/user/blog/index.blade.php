    ...
    @section('content')
        ...
        <section class="bg-gradient-to-r from-gray-600 via-gray-700 to-gray-800 text-white">
            <div class="container mx-auto px-4 py-8 md:py-12 text-center">
                ...
                <h1 class="text-2xl md:text-4xl font-bold max-w-2xl mb-6 mx-auto">{{ $hero ? $hero->title : 'Belum ada title' }}</h1>
                <div class="relative rounded-lg overflow-hidden">
                    <img src="{{ $blog[0] ? asset('storage/' . $blog[0]->image) : 'https://placehold.co/1200x500/C7C7C7/FFFFFF?text=IMG+Post' }}" alt="Featured Blog Post"
                        class="w-full h-auto">
                    ...
                    <div class="absolute bottom-0 left-0 w-full p-2 md:p-8 text-left">
                        ...
                        <div class="bg-black bg-opacity-50 backdrop-blur-sm p-3 md:p-4 rounded-lg max-w-full md:max-w-sm">
                            ...
                            <h2 class="text-sm md:text-xl font-bold mb-1 md:mb-2">{{ Str::limit($blog[0] ? $blog[0]->title : 'Belum ada title', 50) }}</h2>
                                ...
                                <div class="bg-white rounded-lg border border-gray-200 flex flex-col">
                                    ...
                                    <div class="p-5 flex flex-col flex-grow">
                                        ...
                                        <div class="border-t border-gray-200 pt-3 flex justify-between items-center text-xs text-gray-500">
                                            {{-- Anda bisa menambahkan stats di sini jika perlu --}}
                                        </div>
                                    </div>
                                </div>
                            `;
