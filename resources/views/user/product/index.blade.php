                    ...
                    <div class="container mx-auto px-4">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-{{ $kat->layout }} gap-8">
                            @forelse ($kat->produk as $prod)
                                <div
                                    class="bg-gradient-to-r from-gray-50 to-gray-200 rounded-3xl shadow-xl p-5 flex flex-col sm:flex-row items-center space-y-5 sm:space-y-0 sm:space-x-5 h-[420px]">
