        ...
        <div class="bg-white/70 backdrop-blur-lg p-6 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.1)]">
            <div class="flex justify-between items-start">
                <div>
                    ...
                    <p class="text-2xl font-bold text-slate-800 mt-3">{{ $totalVisitsToday }}</p>
                </div>
                <div class="bg-blue-100 text-yellow-500 p-2 rounded-lg">
                    <i data-lucide="eye" class="w-5 h-5"></i>
                </div>
            </div>
            <p class="text-xs {{ $percentageChangeTotal < 0 ? 'text-red-500' : 'text-green-500' }} flex items-center mt-2">
                <i data-lucide="{{ $percentageChangeTotal < 0 ? 'arrow-down' : 'arrow-up' }}" class="w-3 h-3 mr-1"></i>
                {{ $percentageChangeTotal }}% dari kemarin
            </p>
        </div>
        <div class="bg-white/70 backdrop-blur-lg p-6 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.1)]">
            <div class="flex justify-between items-start">
                <div>
                    ...
                    <p class="text-2xl font-bold text-slate-800 mt-3">{{ $uniqueVisitsToday }}</p>
                </div>
            ...
            <p class="text-xs {{ $percentageChangeTotal < 0 ? 'text-red-500' : 'text-green-500' }} flex items-center mt-2">
                <i data-lucide="{{ $percentageChangeTotal < 0 ? 'arrow-down' : 'arrow-up' }}" class="w-3 h-3 mr-1"></i>
                {{ $percentageChangeUnique }}% dari kemarin
            </p>
        </div>
        <div class="bg-white/70 backdrop-blur-lg p-6 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.1)]">
            <div class="flex justify-between items-start">
                <div>
                    ...
                    <p class="text-2xl font-bold text-slate-800 mt-3">{{ $totalVisitsAllTime }}</p>
                </div>
                <div class="bg-blue-100 text-yellow-500 p-2 rounded-lg">
        ...
        <div class="bg-white/70 backdrop-blur-lg p-6 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.1)]">
            <div class="flex justify-between items-start">
                <div>
                    ...
                    <p class="text-2xl font-bold text-slate-800 mt-3">{{ $totalUniqueVisitorsAllTime }}</p>
                </div>
                <div class="bg-blue-100 text-blue-600 p-2 rounded-lg">
