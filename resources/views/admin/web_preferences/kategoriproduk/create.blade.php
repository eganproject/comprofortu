...
@section('content')
    <h2 class="text-2xl font-bold text-slate-800 mb-6">Tambah Kategori Baru</h2>
    ...
    <div x-data="{ image1Preview: null, image2Preview: null }"
        ...
        <form action="/admin/web-preferences/kategori" method="POST" class="space-y-6">
            @csrf
            <div>
                ...
                <input
                    ...
                    type="text" name="nama_kategori" id="nama_kategori" placeholder="Masukkan Nama Kategori" value="{{ old('nama_kategori') }}" required/>
                @error('nama_kategori')
