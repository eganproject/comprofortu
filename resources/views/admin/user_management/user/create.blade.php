...
@section('content')
    ...
    <div x-data="{
        ...
        <div class="md:p-8">
            <form action="/admin/user-management/users" method="POST" class="space-y-6" id="category-form">
                @csrf
                ...
                <div>
                    ...
                    <input
                        class="bg-white border border-slate-300 text-slate-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                        type="text" name="name" id="name" placeholder="Masukkan Nama" value="{{ old('name') }}"
                        required />
                    @error('name')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input
                            ...
                            type="password" name="password" id="password" placeholder="Masukkan Kata Sandi" required />
                    </div>
                    @error('password')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input
                            ...
                            placeholder="Masukkan Kata Sandi Lagi" required />
                    </div>
